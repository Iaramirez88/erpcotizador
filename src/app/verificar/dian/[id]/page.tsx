  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(2,132,199,0.14),_transparent_45%),linear-gradient(180deg,#f8fafc_0%,#eff6ff_100%)] px-4 py-10 text-slate-900">
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="rounded-3xl border border-sky-200 bg-white/90 p-4 shadow-[0_24px_90px_rgba(15,23,42,0.08)] backdrop-blur sm:p-8">
          ...
          <h1 className="mt-4 text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">Documento DIAN identificado</h1>
